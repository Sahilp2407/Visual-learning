...
export default function Topic5_Hallucinations({ onComplete }: TopicProps) {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-[#fafafa] p-8 md:p-12 font-sans overflow-y-auto">
    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 border border-orange-100 text-orange-600 font-bold text-xs uppercase tracking-widest mb-4 shadow-sm">
                ...
                <p className="text-xl text-gray-500 max-w-2xl mx-auto">
                    LLMs sound smart, but if they don't know the answer, they will often <b className="text-gray-800">confidently make it up</b>.
                </p>
            </div>

            {/* INTERACTIVE CARD */}
            <div className="w-full max-w-3xl bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden relative">
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="flex justify-end">
                        <div className="bg-blue-50 text-blue-900 px-6 py-4 rounded-2xl rounded-tr-sm font-medium border border-blue-100 max-w-[80%]">
                    ...
                    <div className="flex gap-4">
                        <div className="w-8 h-8 rounded-full bg-gray-100 shrink-0 mt-2" />
                        <div className="bg-white border border-gray-200 shadow-sm p-6 rounded-2xl rounded-tl-sm w-full relative overflow-hidden group">

                            {/* The Content */}
                            <div className={`space-y-4 transition-all duration-500 ${result === 'BUSTED' ? 'blur-sm opacity-50' : ''}`}>
                                <p className="text-gray-800 font-medium">Here is the financial summary for TechCorp Global (Q3 2024):</p>
                                ...
                                <div className="text-xs text-blue-600 underline cursor-pointer">Source: TechCorp Investor Relations Report 2024</div>
                            </div>
                            ...
                            {result === 'BUSTED' && (
                                ...
                                >
                                    ...
                                    <p className="text-sm font-bold text-gray-600">This company doesn't even exist.</p>
                                </motion.div>
                            )}
        ...
        >
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
                    ...
                    It prioritizes <span className="text-blue-600 font-bold">Fluency</span> (sounding good) over <span className="text-green-600 font-bold">Accuracy</span> (being right).
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                ...
                <motion.div
                    ...
                    className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center group hover:border-blue-200 transition-colors"
                >
                    <div className="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center mb-6">
                        <MessagesSquare size={40} className="text-blue-600" />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Optimized For Fluency</h3>
                    <p className="text-gray-500 mb-8">The AI wants to generate a response that flows naturally, connects logically, and sounds confident.</p>
                ...
                <motion.div
                    ...
                    className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center group hover:border-red-200 transition-colors"
                >
                    <div className="w-20 h-20 bg-red-50 rounded-full flex items-center justify-center mb-6">
                        <ShieldAlert size={40} className="text-red-500" />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Accuracy is Optional</h3>
                    <p className="text-gray-500 mb-8">Unless connected to external tools (like Search), the AI relies on "fuzzy memories" from training data.</p>
            ...
            <button
                onClick={onNext}
                className="mt-12 px-10 py-4 bg-black text-white rounded-full font-bold uppercase tracking-widest shadow-2xl hover:scale-105 transition-transform flex items-center gap-3"
            >
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                ...
                <div className="bg-white rounded-[2rem] p-8 shadow-xl border border-gray-200">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 flex gap-4">
                            <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-500">1</div>
                            <div>
                                <div className="font-bold text-gray-900 text-sm">Ask for Sources</div>
                                <div className="text-xs text-gray-500">"Where did you find this? Provide a URL." (If it can't, it's lying).</div>
                            </div>
                        </div>
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 flex gap-4">
                            <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-500">2</div>
                            <div>
                                <div className="font-bold text-gray-900 text-sm">Cross-Examine</div>
                                <div className="text-xs text-gray-500">"Ask the same question in 3 different ways." Inconsistencies = Hallucination.</div>
                            </div>
                        </div>
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 flex gap-4">
                            <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-500">3</div>
                            <div>
                                <div className="font-bold text-gray-900 text-sm">Check Live Data</div>
                                <div className="text-xs text-gray-500">Only trust verifiable facts if the model has browsing capabilities enabled.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-900 rounded-[2rem] p-8 shadow-2xl text-white relative overflow-hidden">
